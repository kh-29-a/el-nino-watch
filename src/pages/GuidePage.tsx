const guideSections = [
  ...
  ['Trade wind anomaly', 'NOAA CPC’s monthly 850-hPa indices compare trade winds with normal conditions in the West, Central, and East Pacific. Negative values mean weakened easterly trades / anomalous westerlies and favor El Niño-like behavior; positive values mean stronger easterlies and favor La Niña-like behavior. Current wind and wind anomaly are different quantities, and surface wind and 850-hPa indices are not interchangeable.'],
]
